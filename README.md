...
```json
{
  ...
  "summary": "AI Product Lead at Open Future Labs focused on AI, Product, Automation.",
  "hashtags": ["#AI", "#Product", "#Automation", "#Llm", "#Startup"],
  "input_files": {
    "photo": "/path/to/photo.jpg",
    "resume_pdf": "/path/to/resume.pdf"
  },
  "output_file": "output/poster.png"
}
```
